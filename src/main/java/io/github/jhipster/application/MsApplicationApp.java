...
public class MsApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(MsApplicationApp.class);

    private final Environment env;

    public MsApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes msApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MsApplicationApp.class);
